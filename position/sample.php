...
$jssdk = new JSSDK("wxc27ddb489017a49a", "nZkUHupnnI7ad0bSkuUnjzW1TeJrLPm-8z9_kUUKjj9TdITOtOuobEe5k757Bmsr");
        ...
        $.ajax({  	
	      ...
	      success: function (data) {  
				...
				var csrf_test_name = getCsrf();
                    ...
                    $.post('http://new.ectop.cn/hl/index.php/app/jiudian/jiudian_query/dingwei', objtops(objects)).success(function (data) { 
						alert(1112);
						alert(data);
					});    
