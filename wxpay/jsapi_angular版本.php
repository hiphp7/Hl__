...
$input->SetNotify_url("http://new.ectop.cn/wxpayg/example/notify.php");
                            ...
                            <div class="fliTimenbox pt_35">
                                <div class="toFliTime pb_100">
                                    ...
                                    <span class="wid30 fl text_a_c">
                                        <p class="maxIcon pl_150 mt_150 pr_150"><img src='http://new.ectop.cn/hl/resources/air/image/fdfdv.png'></p>
                                    </span>
...
angular.module("myApp",["ionic"]).controller("MyWXPayCtrl",function($scope){
    ...
    console.log(order);
			...
			$scope.retunurl = function(){
                window.location.href = 'http://new.ectop.cn/hl/index.php#/tab/order';
            };
});
