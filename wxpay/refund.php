...
function printf_info($data)
{
    ...
    foreach($data as $key=>$value){
		...
		if($key == 'result_code' && $value == 'SUCCESS')
		{
			$index++;
		}
		
		if($key == 'return_code' && $value == 'SUCCESS')
		{
			$index++;
		}
		
		if($key == 'return_msg' && $value == 'OK')
		{
			$index++;
		}
    }
...
?>
<body>  
	<form action="http://m.bibi321.com/hl/wxpay/refund.php" method="get">
