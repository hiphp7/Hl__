Ext.ux.MyTipsWindow = Ext.extend(Ext.Window, {
    width: 200,
    height: 150,
    layout: 'fit',
    modal: false,
    ...
    manager: new Ext.WindowGroup({ zseed: 2147000000 }),
    //设置window所属的组
    constructor: function(conf) {
        Ext.ux.MyTipsWindow.superclass.constructor.call(this, conf);
        this.initPosition(true);
    },
    initEvents: function() {
        Ext.ux.MyTipsWindow.superclass.initEvents.call(this);
        //自动隐藏
    ...
    initPosition: function(flag) {
        ...
        var top = bd.scrollTop + Ext.lib.Dom.getViewHeight() - 35 - this.height;
