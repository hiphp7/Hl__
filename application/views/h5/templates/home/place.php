<ion-view view-title="比比旅行"> 
 ...
 <ion-header-bar class="bar-positive " style="height:4rem">
   ...
   <ion-content scroll="true" class="has-header ng-hide searchList" padding="true"  style="top:9rem" ng-show="content !='' " >
        <div data-ng-repeat="x in searchList" style="padding-right: 118px;">
    ...
    <ion-content scroll="true" class="has-header ng-hide" padding="true" style="position: absolute;top:9rem;" ng-show="content ==''"  >
        <div>
                ...
                <div class="row" style="padding-right: 118px;" >
                  <div class="col col-30 button button-light button-small " style="margin:2px;font-size:16px;" ng-repeat="v in history" ng-click="showHomePage(v)">{{v.city}}</div>
                ...
                <div style="margin-left:10px;font-size:16px;"> 热门城市</div>
                  <div class="row" style="padding-right: 118px;" ng-repeat="v1 in remenplace">
                    <div class="col col-30 button button-light button-small" style="margin:2px;font-size:16px;" ng-repeat="v2 in v1" ng-click="showHomePage(v2)">{{v2.city}}</div>
                  </div>
