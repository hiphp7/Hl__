...
<ion-view view-title="比比旅行" class='trainList' >
	...
	<a class="button icon-left ion-ios-arrow-left button-clear " style="color:#fff;font-size: 0.768rem;" onclick="history.go(-1)">返回</a>
	<span class="title"><span  ng-bind="search.current.depStation"></span><i></i><span ng-bind="search.current.arrStation"></span></span>

	<a class="button icon-right  button-clear " style="color:#fff;font-size: 0.768rem;" ng-click="getSearchList(true)">差返程</a>


	</ion-header-bar>
	<ion-header-bar align-title="center" class="bar-subheader" style="height: 2.7rem;line-height: 2.7rem;padding: 0px" ng-style="display.head" style="display:none;">
	    <div class="trainMenu" >
	...
	<div class="center" style="margin-top: 0rem">
	    ...
	    <ul class="list" ng-style="myStyle.loadfinish" style="display:none; margin-top: 0.4rem" ng-if="display.central == 'loadfinish'">
	        ...
	        <li ng-repeat="x in trainList |orderBy:sortBy:sortDesc" ng-if="x.seatList.length >0">
	            ...
	            <div class="baseInfo" ng-click="baseInfo($event)">
	                ...
	                <div class="column df-c-c-c">
	                    ...
	                    <span class="content">
	                        ...
	                        <span class="trains" ng-bind="x.train_code + '次'"></span>

	                    <i class="icon-arrow"></i>

	                    <span class="time" ng-bind="x.costtime"></span>
	                ...
	                <div class="column df-c-c-c">
	                    ...
	                    <span class="time" ng-bind="x.arrive_time"></span>

	                </div>

	                <div class="column df-c-c-c">

	                    <span class="money"><i>￥</i><span ng-bind="x.lowerprice.price + '起'"></span></span>

	                </div>

	            </div>

	            <div class="simpleInfo {{className}}" style="display: block;">
	    ...
	    <section class="ticketQueryNoData" ng-style="myStyle.loadfinish" ng-if="display.central == 'loadempty'">
	        ...
	        <div class="usrbox zoom05 df-c-c-r"><img src="http://localhost:8877/myair/resources/train/images/popupImg.png" alt=""></div>

	        <p><span ng-bind="errMsg"></span>

	            <br />请更换条件重新查询。</p>

	        <a href="index.html" class="dp_b nsjah_a f_s16 text_a_c">确认</a>
	    ...
	    <section class="ticketQueryFailure" ng-style="myStyle.loadfinish" ng-if="display.central == 'loaderr'">
	        ...
	        <div class="usrbox zoom05"><img src="http://localhost:8877/myair/resources/train/images/popupImg.png" alt=""></div>
	    ...
	    <div class="loadingT" ng-style="myStyle.loading" ng-if="display.central == 'loading'" >
	        ...
	        <div class="load load-animation">
	            ...
	            <span class="imgBg imgBg-animation">
	               ...
	               <img src="http://localhost:8877/myair/resources/train/images/bg_picture.jpg" alt="" class="bgImg bgImg-animation">

	               <img src="http://localhost:8877/myair/resources/train/images/ic_railway.png" alt="" class="rail rail-animation">

	               <img src="http://localhost:8877/myair/resources/train/images/ic_train.png" alt="" class="train train-animation">
	...
	<ion-footer-bar align-title="left" class=" foot" style="background-color: #5B6B8;display:none;" ng-style="myStyle.loadfinish" ng-show="display.foot">
    ...
    <script id="templates/shaixuan.html" type="text/ng-template">
      <ion-modal-view style="top:50%;width: 100%;left: 0px;height: 50%;">
        <ion-header-bar class="bar bar-header bar-positive" style="background: #5a6b84;height: 2.6rem;line-height: 2.6rem;">

            <a class="button icon-left  button-clear " style="margin-left: 5%;width: 15%;text-align: left;line-height: 2.6rem;font-size: 0.768rem !important;top:0px" ng-click="searchfilter(false)">取消</a>
            <span class="title" style="line-height: 2.6rem;font-size: 0.768rem !important">选择筛选条件</span>

            <a class="button icon-right  button-clear " style="color:#fff;margin-right: 5%;width: 15%;text-align: right;line-height: 2.6rem;font-size: 0.768rem !important;top:0px" ng-click="searchfilter(true)">确定</a>
        </ion-header-bar>
