                ...
                <tbody>
                    <?php foreach ($chanpin as $k => $v): ?>
                        <tr>
                            ...
                            <td><input type="radio" name="zhuangtai_<?php echo $k ?>" id="zhuangtai_<?php echo $k ?>" >是否开启</td>
                            <td><input type="radio" <?php if ($k==2) { } else {echo "disabled=disabled"; };?> name="qianyuefangshi_<?php echo $k ?>" id="qianyuefangshi_<?php echo $k ?>" >是否按交易额计算</td>
                        </tr>
