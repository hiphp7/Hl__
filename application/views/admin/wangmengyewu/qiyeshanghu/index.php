    ...
    <div class="col-md-4">
        <div class="row">
            <form id='frm_chx'>
                ...
                <a class="btn btn-warning" href='<?php echo site_url("admin/wangmengyewu/qiyeshanghu/kaihu"); ?>' role="button">&nbsp&nbsp开户&nbsp&nbsp</a>
                </div>
            </form>
        </div>
    </div>
...
var table;
        $(function () {
            ...
            ajax : {
                url : '<?php echo site_url("admin/wangmengyewu/qiyeshanghu/all"); ?>',
                dataSrc : "myData",
                type : "post",
                data : function (d) {
            ...
            , {
                    ...
                    fnCreatedCell : function (nTd, sData, oData, iRow, iCol) {
                        $(nTd).html("<a id='chakan_a_" + oData.shanghuhao + "' href='<?php echo site_url("admin/wangmengyewu/qiyeshanghu/xiangqing/");?>/" + oData.shanghuhao + "'>查看详情</a>&nbsp;&nbsp;")
