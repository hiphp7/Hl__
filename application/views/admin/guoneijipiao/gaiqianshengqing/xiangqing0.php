                            ...
                            <div class="panel-body">
                                <table class="table" style="margin-bottom:0px;">
                                     <tbody>
                                          ...
                                          <tr>
                                              <td>航班日期：<?php echo $xq->hangbanriqi; ?></td>
                                              <td>起飞时间：<?php echo $xq->qifeishijian; ?></td>
                                              <td>抵达时间：<?php echo $xq->didashijian; ?></td>
                                              <td>航班号：<?php echo $xq->hangbanhao; ?></td>
                                          </tr>
                                          <tr>
                                              <td>成人舱位：<?php echo $xq->chengrencangwei; ?></td>
                                              <td>成人单张手续费：<?php echo $xq->chengrenshouxufei; ?></td>
                                              <td colspan="2">成人单张升舱费：<?php echo $xq->chengrenshengcangfei; ?></td>
                                          </tr>
                                          <tr>
                                              <td>儿童舱位：<?php echo $xq->ertongcangwei; ?></td>
                                              <td>儿童单张手续费：<?php echo $xq->ertongshouxufei; ?></td>
                                              <td colspan="2">儿童单张升舱费：<?php echo $xq->ertongshengcangfei; ?></td>
                                          </tr>
                                     </tbody>
                                </table>
                            </div>
