                        ...
                        <div class="panel panel-primary">
                            ...
                            <div class="panel-body">
                                ...
                                <table class="table mytable" style="margin-bottom:0px;">
                                     ...
                                     <tbody>
                                         <?php foreach ($obj->lst as $c): if($c->baodanzhuangtai == 1):?>
                                          <tr>
                                              ...
                                              <td><input id="baodanhao_<?php echo $c->id; ?>" baoxianid="<?php echo $c->id; ?>" name="baodanhao_<?php echo $c->id; ?>" placeholder="保单号" type="text"><span style="color:red">&nbsp;*&nbsp;</span></td>
                                              <td><input id="shengxiaoriqi_<?php echo $c->id; ?>" baoxianid="<?php echo $c->id; ?>" name="shengxiaoriqi_<?php echo $c->id; ?>" placeholder="生效日期" type="text"><span style="color:red">&nbsp;*&nbsp;</span></td>
                                ...
                                <table class="table mytable" style="margin-bottom:0px;">
                                     <tbody>
                                          <tr>
                                              <td>外采平台:</td>
                                              <td><input id="waicaipingtai" name="waicaipingtai" placeholder="外采平台" type="text"><span style="color:red">&nbsp;*&nbsp;</span></td>
                                              <td>外采订单编号:</td>
                                              <td><input id="waicaidingdanbianhao" name="waicaidingdanbianhao" placeholder="外采订单编号" type="text"><span style="color:red">&nbsp;*&nbsp;</span></td>
                                          </tr>
                                          <tr>
                                              <td>外采总价:</td>
                                              <td><input id="waicaizongjia" name="waicaizongjia" placeholder="外采总价" type="text"><span style="color:red">&nbsp;*&nbsp;</span></td>
                                              <td>外采备注:</td>
                                              <td><input id="waicaibeizhu" name="waicaibeizhu" placeholder="外采备注" type="text"></td>
                                          </tr>
                                     </tbody>
                                </table>
                                <div class="row">
                                     <div style="float:right;">
                                         ...
                                         <input class="btn btn-success" id="btn_tijiao" value="完成投保处理" type="submit">
                                         <!--
                                         <input class="btn btn-success" id="btn_tijiao" value="完成投保处理" type="button">
                                         -->
                                     </div>
                                </div>
                            </div>
