			...
			, {
					...
					fnCreatedCell : function (nTd, sData, oData, iRow, iCol) {
						...
						else if(oData.suodan_zt == '自己锁单')
						{
					        ...
					        else if(oData.dingdanzhuangtai != '处理完成')
					        {
						     $(nTd).html("<a href='<?php echo site_url("admin/guoneijipiao/chupiao/index");?>/" + oData.hid + "'>锁单</a>&nbsp;&nbsp;");
					        }
                                                else
                                                {
                                                     $(nTd).html("<a id='chakan_a_" + oData.hid + "' href='<?php echo site_url("admin/guoneijipiao/chupiao/xiangqing/");?>/" + oData.hid + "'>查看</a>");
