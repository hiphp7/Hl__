            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div id="yidipingtaichupiao" class="tab-pane fade active in" role="tabpanel" aria-labelledby="yidipingtaichupiao_tab">
                        <?php echo form_open('admin/guoneijipiao/chupiao/yidicp', array('id' => 'yidiform', 'name' => 'yidiform', 'class' => 'form-signin')); ?>
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td>异地平台名称:</td>
                    ...
                    <div id="bendichupiao" class="tab-pane fade active in" role="tabpanel" aria-labelledby="bendichupiao_tab" style="display:none;">
                        <?php echo form_open('admin/guoneijipiao/chupiao/bendicp', array('id' => 'bendiform', 'name' => 'bendiform', 'class' => 'form-signin')); ?>
                        <table class="table">
                            <tbody>
                                <tr>
                                    <td>订座记录PNR:</td>
...
<div class="row">
    ...
    <div class="col-md-12">
        <h4>
            <a href='<?php echo site_url("admin/guoneijipiao/chupiao/index"); ?>'>机票订单管理</a> / <a href='<?php echo site_url("admin/guoneijipiao/chupiao/index"); ?>'>出票管理</a> / <a href='#'>出票处理</a></h4>
    </div>
</div>
<?php echo form_open('admin/guoneijipiao/chupiao/cp', array('id' => 'chupiaoform', 'name' => 'chupiaoform', 'class' => 'form-signin')); ?>
<!-- 出票成功 -->
<div class="row">
    <div class="col-md-12">
                        ...
                        <table class="table mytable" style="margin-bottom:0px;">
                            ...
                            <tbody>
                                <?php if (!empty($hangchenglvke_tongji) && $index == 1): ?>
                                    ...
                                    <?php endforeach; ?>
                                <?php endif; ?>
                                <?php if (!empty($hangchenglvke_tongji) && $index == 2): $c = $hangchenglvke_tongji[1]; ?>
