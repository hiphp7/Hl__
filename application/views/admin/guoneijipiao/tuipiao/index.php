                            ...
                            <table id="prohighsearchtable" style="width: 100%;">
                                <tbody>
                                    ...
                                    <tr style="margin-top: 5px;">
                                        ...
                                        <td>
                                            <input type="text" placeholder="乘客票号" id="cha_piaohao"/>
                                        </td>
        ...
        $(function () {
			...
			ajax : {
				...
				data : function (d) {
                                        ...
                                        var piaohao = $.trim($('#cha_piaohao').val());
                                        d.piaohao = piaohao != 'on'? piaohao: '';										
			...
			, {
					...
					fnCreatedCell : function (nTd, sData, oData, iRow, iCol) {
						...
						if(oData.chulizhuangtai == '2' || oData.chulizhuangtai == '3')
                                                {
                                                    $(nTd).html("<a id='chakan_a_" + oData.id + "' href='<?php echo site_url("admin/guoneijipiao/tuipiao/xiangqing/");?>/" + oData.id + "/" + oData.chuli + "/" + oData.tuipiaoleixing + "'>查看</a>");
                                                }
                                                else if(oData.chulizhuangtai == '0')
                                                {
                                                    ...
                                                    {
                                                        $(nTd).html("已锁单&nbsp;&nbsp;")
                                                              .append("<a id='chakan_a_" + oData.id + "' href='<?php echo site_url("admin/guoneijipiao/tuipiao/xiangqing/");?>/" + oData.id + "/" + oData.chuli + "/" + oData.tuipiaoleixing + "'>查看</a>&nbsp;&nbsp;");
                                                    }
                                                    if(oData.suodan == '')
                                                    {
                                                       $(nTd).html("<a href='<?php echo site_url("admin/guoneijipiao/tuipiao/index");?>/" + oData.id + "'>锁单</a>&nbsp;&nbsp;")
                                                             .append("<a id='chakan_a_" + oData.id + "' href='<?php echo site_url("admin/guoneijipiao/tuipiao/xiangqing/");?>/" + oData.id + "/" + oData.chuli + "/" + oData.tuipiaoleixing + "'>查看</a>&nbsp;&nbsp;");
                                                    }
                                                    else if(oData.suodan_self == '1')
                                                    {
                                                        $(nTd).html("<a id='jiesuo_a_" + oData.id + "' href='<?php echo site_url("admin/guoneijipiao/tuipiao/jiesuo/");?>/" + oData.id + "'>解锁</a>&nbsp;&nbsp;")
                                                           .append("<a id='chakan_a_" + oData.id + "' href='<?php echo site_url("admin/guoneijipiao/tuipiao/xiangqing/");?>/" + oData.id + "/" + oData.chuli + "/" + oData.tuipiaoleixing + "'>查看</a>&nbsp;&nbsp;")
                                                              .append("<a id='chuli_a_" + oData.id + "' href='<?php echo site_url("admin/guoneijipiao/tuipiao/tuipiaochuli/");?>/" + oData.id + "/" + oData.tuipiaoleixing + "'>处理</a>");
                                                    }
                                                }
					}
				}]
