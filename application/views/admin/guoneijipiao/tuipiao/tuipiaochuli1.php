               ...
               <?php $CI = & get_instance(); echo form_open('admin/guoneijipiao/tuipiao/tp', array('id' => 'tuipiaoform', 'name' => 'tuipiaoform', 'class' => 'form-signin'));?>
                                         ...
                                         <?php if (!empty($c->shifouertong)): ?>
                                          <tr>
                                              ...
                                              <td>&yen;<span id='gmjg_<?php echo $c->id; ?>'><?php echo floatval($c->piaomiandanjia) + floatval($c->ranyoushui); ?></span>
                                                  <input type="hidden" id='total_fee' name='total_fee' value='<?php echo floatval($c->piaomiandanjia) + floatval($c->ranyoushui); ?>'/>
                                              </td>
                                              <td>&yen;<?php echo $c->piaomiandanjia; ?></td>
                                              <td>0.5%</td>
                                              <td>&yen;<?php echo $c->ranyoushui; ?></td>
                                              <td><input id='chupiaobianma_<?php echo $c->id; ?>' onkeyup='jishuan("gmjg_<?php echo $c->id; ?>", "chupiaobianma_<?php echo $c->id; ?>", "sjtk_<?php echo $c->id; ?>")' name='chupiaobianma_<?php echo $c->id; ?>' type="text" placeholder="退票费/张"/></td>
                                              <td><span id='sjtk_<?php echo $c->id; ?>'></span><input type="hidden" id='refund_fee' name='refund_fee'/></td>
                                ...
                                <table class="table mytable" style="margin-bottom:0px;">
                                     ...
                                     <tbody>
										  ...
										  <?php endforeach; ?>
                                           <tr>
                                              <td>退票原因：</td>
                                              <td><?php echo $tp->tuipiaoyuanyin; ?></td>
                                              <td>是否自愿：</td>
                                              <td colspan="4">
                                                  <select id="sel_tuipiaoleixing" name="sel_tuipiaoleixing">
                                                      <option selected="selected" value="0">自愿</option>
                                                      <option value="1">非自愿</option>
                                                  </select>
                                                  <input type="hidden" id="tuipiaoleixing" name="tuipiaoleixing" />
                                              </td>
                                          </tr>
                                     </tbody>
                                </table>
                ...
                <div class="row">
                    <div style="float:right;">
                        <input id="wuftuipiap" name="wuftuipiap" type="hidden" value="0" />
                         <input type="submit" class="btn btn-danger" value='确定退款'></input>
                         &nbsp;&nbsp;
                         <input type="submit" class="btn btn-success" id="btn_wufa" value='无法退票'></input>
                    </div>
                </div>
                <input type="hidden" id='hangchenglvkeid' value='<?php echo $hangchenglvid; ?>' name='hangchenglvkeid' />
