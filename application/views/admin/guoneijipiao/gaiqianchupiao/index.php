...
var table;
        $(function () {
            ...
            ajax : {
                url : '<?php echo site_url("admin/guoneijipiao/gaiqianchupiao/all"); ?>',
                dataSrc : "myData",
                type : "post",
                data : function (d) {
                                        var csrf_name = getCookie('csrf_cookie_name');
            ...
            , {
                    ...
                    fnCreatedCell : function (nTd, sData, oData, iRow, iCol) {
                        ...
                        {
                            $(nTd).html("已锁单&nbsp;&nbsp;")
                                                              .append("<a id='chakan_a_" + oData.hid + "' href='<?php echo site_url("admin/guoneijipiao/gaiqianchupiao/xiangqing/");?>/" + oData.hid + "'>查看</a>&nbsp;&nbsp;");
                        }
                                                
                        else if(oData.suodan == '' && ( oData.dingdanzhuangtai_int == '1' || oData.dingdanzhuangtai_int == '2' ))
                        {
                                                    $(nTd).html("<a href='<?php echo site_url("admin/guoneijipiao/gaiqianchupiao/index");?>/" + oData.id + "'>锁单</a>&nbsp;&nbsp;")
                                                          .append("<a id='chakan_a_" + oData.hid + "' href='<?php echo site_url("admin/guoneijipiao/gaiqianchupiao/xiangqing/");?>/" + oData.hid + "'>查看</a>");
                        }
                                                else if(oData.dingdanzhuangtai_int != '1' && oData.dingdanzhuangtai_int != '2' )
                                                {
                                                        $(nTd).html("<a id='chakan_a_" + oData.hid + "' href='<?php echo site_url("admin/guoneijipiao/gaiqianchupiao/xiangqing/");?>/" + oData.hid + "'>查看</a>");
                                                }
                                                else
                                                {
                                                        $(nTd).html("<a id='jiesuo_a_" + oData.hid + "' href='<?php echo site_url("admin/guoneijipiao/gaiqianchupiao/jiesuo/");?>/" + oData.hid + "'>解锁</a>&nbsp;&nbsp;")
                                                          .append("<a id='chakan_a_" + oData.hid + "' href='<?php echo site_url("admin/guoneijipiao/gaiqianchupiao/xiangqing/");?>/" + oData.hid + "'>查看</a>&nbsp;&nbsp;")
                                                          .append("<a id='chuli_a_" + oData.hid + "' href='<?php echo site_url("admin/guoneijipiao/gaiqianchupiao/chupiaochuli/");?>/" + oData.hid + "'>处理</a>");
                                                }
                    }
                }]
