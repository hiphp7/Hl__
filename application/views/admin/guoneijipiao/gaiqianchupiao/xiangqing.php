			...
			<div class="row">
                    ...
                    <div class="col-md-12">
                        <h4>
                            <a href='<?php echo site_url("admin/guoneijipiao/chupiao/index"); ?>'>机票订单管理</a> / <a href='<?php echo site_url("admin/guoneijipiao/gaiqianchupiao/index"); ?>'>出票管理</a> / <a href='<?php echo site_url("admin/guoneijipiao/gaiqianchupiao/xiangqing"); ?>'>出票订单详细</a></h4>
                    </div>
                </div>
                <!-- 出票成功 -->
                <div class="row">
