                   ...
                   <div style="line-height: 30px;">
                      <div >
                          ...
                          <div style="width: 80%; float: left;" id="a_refund3">
                              ...
                              <div style="width: 100%; float: left;">
                                  <div style="margin-right:10px;">起飞后<span style="right: 20px; float: right;"><span class="a_refundPercentAfter"></span></span></div>
                              </div>
                          </div>
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <span style="font-size:18px;"><?php echo $obj_tuipiaodingdan->shenqinghao; ?>&nbsp;&nbsp;</span><span style="font-size:18px; color:Red;"><?php
                    ...
                    echo $myconfig[intval($obj_tuipiaodingdan->chulizhuangtai)];
                    ?></span>
            </div>
...
<div class="row">
    <div class="col-md-12">
        ...
        if (!empty($hangc)) {
            foreach ($hangc as $a): $hc = $a->hangcheng;
                            ...
                            function tuigaiqianguize(hangchengid)
                            {
                                ...
                                $.post('<?php echo site_url("admin/guoneijipiao/gaiqianshengqing/chahangchengtuigaiqian"); ?>/' + hangchengid, {csrf_test_name: csrf_name}, function (data) {
                                  ...
                                  $("#a_change4").hide();
                                    ...
                                    if (data[0]['refundTimePointAadvance'] !='') {
                                       $("#a_refund1").show();
                                    ...
                                    if (data[0]['changeTimePointAdvance'] !='') {
                                       $("#a_change1").show();
                                    } else if (data[0]['changeTimePointAdvance'] == '' && data[0]['changeTimePoint'] != 0 && data[0]['changeTimePoint'] != '') {
                                      $("#a_change2").show();
                                    } else if (data[0]['changeTimePointAdvance'] == '' && data[0]['changeTimePoint'] == 0 && data[0]['changeTimePoint'] != '') {
                                      $("#a_change3").show();
                                    } else {
                                    ...
                                    $("#c_change4").hide();
                                      ...
                                      if (data[1]['refundTimePointAadvance'] !='') {
                                         $("#c_refund1").show();
                                      ...
                                      if (data[1]['changeTimePointAdvance'] !='') {
                                         $("#c_change1").show();
                                      } else if (data[1]['changeTimePointAdvance'] == '' && data[1]['changeTimePoint'] != 0 && data[1]['changeTimePoint'] != '') {
                                        $("#c_change2").show();
                                      } else if (data[1]['changeTimePointAdvance'] == '' && data[1]['changeTimePoint'] == 0 && data[1]['changeTimePoint'] != '') {
                                        $("#c_change3").show();
                                      } else {
