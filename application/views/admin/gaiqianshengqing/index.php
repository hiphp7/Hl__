                            ...
                            <table id="prohighsearchtable" style="width: 100%;">
                                <tbody>
                                    <tr>
                                        ...
                                        <td>
                                            <input type="text" placeholder="申请编号" id="cha_shenqinghao"/>
                                        </td>
                                    ...
                                    <tr style="margin-top: 5px;">
                                        ...
                                        <td colspan="3">
                                            <select id="cha_shenqingzhuangtai">
        ...
        $(function () {
			...
			ajax : {
				...
				data : function (d) {
                                        ...
                                        var shenqinghao = $.trim($('#cha_shenqinghao').val());
                                        d.shenqinghao = shenqinghao != 'on'? shenqinghao: '';
                                        
                                        var zhongwenming = $.trim($('#cha_zhongwenming').val());
                                        d.zhongwenming = zhongwenming != 'on'? zhongwenming: '';
                                        
                                        var shenqingzhuangtai = $.trim($('#cha_shenqingzhuangtai').val());
			...
			, {
					...
					fnCreatedCell : function (nTd, sData, oData, iRow, iCol) {
                                                // 假如处理完成 就只能查看
						if(oData.shenqingzhuangtai == '2' || oData.shenqingzhuangtai == '5')
                                                {
                                                    $(nTd).html("<a id='chakan_a_" + oData.id + "' href='<?php echo site_url("admin/guoneijipiao/gaiqianshengqing/xiangqing/");?>/" + oData.id + "'>查看</a>");
                                                }
                                                else if(oData.shenqingzhuangtai == '0')
                                                {
                                                    if(oData.suodan == '')
                                                    {
                                                       $(nTd).html("<a href='<?php echo site_url("admin/guoneijipiao/gaiqianshengqing/index");?>/" + oData.id + "'>锁单</a>&nbsp;&nbsp;")
                                                             .append("<a id='chakan_a_" + oData.id + "' href='<?php echo site_url("admin/guoneijipiao/gaiqianshengqing/xiangqing/");?>/" + oData.id + "'>查看</a>&nbsp;&nbsp;");
                                                    }
                                                    else if(oData.suodan_self == '0')
                                                    {
                                                        $(nTd).html("已锁单&nbsp;&nbsp;")
                                                              .append("<a id='chakan_a_" + oData.id + "' href='<?php echo site_url("admin/guoneijipiao/gaiqianshengqing/xiangqing/");?>/" + oData.id + "'>查看</a>&nbsp;&nbsp;");
                                                    }
                                                    ...
                                                    {
                                                        $(nTd).html("<a id='jiesuo_a_" + oData.id + "' href='<?php echo site_url("admin/guoneijipiao/gaiqianshengqing/jiesuo/");?>/" + oData.id + "'>解锁</a>&nbsp;&nbsp;")
                                                           .append("<a id='chakan_a_" + oData.id + "' href='<?php echo site_url("admin/guoneijipiao/gaiqianshengqing/xiangqing/");?>/" + oData.id + "'>查看</a>&nbsp;&nbsp;")
                                                              .append("<a id='chuli_a_" + oData.id + "' href='<?php echo site_url("admin/guoneijipiao/gaiqianshengqing/gaiqianchuli/");?>/" + oData.id +"'>处理</a>");
                                                    }
                                                }
                                                else
                                                {
