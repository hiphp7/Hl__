    ...
    <div class="col-md-12">
        <div class="row">
            ...
            <div class="col-md-8">
                ...
                &nbsp;
                &nbsp;
                <button type="button" data-target="#modifyModal" data-toggle="modal" class="btn btn-success">修改保险公司</button>
                &nbsp;
                &nbsp;
                <button type="button" id="delbtn" data-toggle="modal" class="btn btn-success">删除保险公司</button>
            </div>
        </div>
    </div>
</div>
    ...
    <div role="document" class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-primary" id="btn_excel" type="button">保存</button>
...
var table;
        $(function () {
			...
			ajax : {
				url : '<?php echo site_url("admin/pingtaiguanli/guanliyuanzu/all"); ?>',
				dataSrc : "myData",
				type : "post",
				data : function (d) {
