...
<script type="text/javascript">
	...
	@font-face{
		...
		src:url('../system/fonts/PingFang Bold.ttf');
	}
	*{
...
<body>
	...
	<h1 class="form-signin-heading">后台管理系统</h1>
        <?php if (!empty($tj) && $tj == '1'): ?>
        <div>
            <span style="color:red;">注册成功请登录</span>
        </div>
        <?php endif; ?>
        <?php echo form_open('admin/login/mylogin', array('id' => 'loginForm', 'name' => 'loginForm', 'class' => 'form-signin'));?>
