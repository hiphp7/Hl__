<div class="row">
    ...
    <div class="col-md-12">
        <h4>
            <a href='<?php echo site_url("admin/caiwuguanli/jiudianjudan/index"); ?>'>酒店拒单报表下载 </a> / <a href='<?php echo site_url("admin/caiwuguanli/jiudianjudan/index"); ?>'>酒店拒单报表</a>
        </h4>
    </div>
...
<script type="text/javascript">
    ...
    $("#btn_daochu").click(function(event) {
        ...
        window.location.href = '<?php echo site_url("admin/caiwuguanli/jiudianjudan/judan"); ?>' +'?'+ data + '&';
