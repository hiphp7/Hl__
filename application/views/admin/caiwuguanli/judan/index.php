<div class="row">
    ...
    <div class="col-md-12">
        <h4>
            <a href='<?php echo site_url("admin/caiwuguanli/jipiaobaobiao/index"); ?>'>国内机票报表下载 </a> / <a>拒单报表</a>
        </h4>
    </div>
        ...
        <table  style="width: 100%;">
            <tbody>
                <tr>
                    ...
                    <td colspan="3">
                        <select name="leixing" id="leixing" style="padding-right: 0px"><option value="0" selected="selected">退票时间</option><option value="1">退款时间</option></select>
...
<script type="text/javascript">
    ...
    $("#btn_daochu").click(function(event) {
            ...
            window.location.href = '<?php echo site_url("admin/caiwuguanli/judan/judanbaobiao"); ?>' +'?'+ data + '&';
