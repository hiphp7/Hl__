<div class="row">
    ...
    <div class="col-md-12">
        <h4>
            <a href='<?php echo site_url("admin/caiwuguanli/jipiaobaobiao/index"); ?>'>国内机票报表下载 </a> / <a >改签出票报表</a>
        </h4>
    </div>
...
<script type="text/javascript">
    ...
    $("#btn_daochu").click(function(event) {
            ...
            window.location.href = '<?php echo site_url("admin/caiwuguanli/gaiqianchupiao/gaiqianchupiaobaobiao"); ?>' +'?'+ data + '&';
