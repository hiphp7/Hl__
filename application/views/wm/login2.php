        ...
        <div  style="width: 354px; padding: 20px 0;">
          <form class="form-horizontal" style="overflow:auto; box-shadow: 0px 0px 10px #666666; border: 0px none;"  id="loginform" >
                ...
                <div class="form_hang">
                    ...
                    <input type="password" class="form_h" name="pwd" id="pwd" placeholder="请输入密码" onblur="show_Icon('psd')"  value="<?php if(!empty($password)) echo $password ;?>">
                ...
                <div class="form_hang" style="margin: 20px">
                    ...
                    <button type="button" class="btn btn-default denglu" style="width: 100%; color: white !important">登&nbsp;录</button>
                </div>
            </form>
        </div>
    </div>
