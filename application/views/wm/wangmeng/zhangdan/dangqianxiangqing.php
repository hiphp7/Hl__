    ...
    <div class="panel-default" style=" border: 0;">
        <div class="panel-heading" style="border: none;">
            <ul class="list-inline zhangdan_ul">
                <li style="font-size: 18px;font-weight: 600;color: #666666;">账单起始日期</li>
                <li style="font-size: 18px;font-weight: 600;color: #666666;">账单截止日期</li>
                <li style="font-size: 18px;font-weight: 600;color: #666666;">佣金总计(元)</li>
                <li style="font-size: 18px;font-weight: 600;color: #666666;">结算时间</li>
                <li style="font-size: 18px;font-weight: 600;color: #666666;">结算操作员</li>
            </ul>
        </div>
        <div class="panel-body" style="padding: 0 15px;">
            <ul class="list-inline zhangdan_ul">
                ...
                <li style="color: #73ccd2;font-weight: bold;"><?php echo $info->yongjinzonge; ?></li>
