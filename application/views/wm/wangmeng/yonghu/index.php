...
<div class="row" style="color: #666666;">
    ...
    <div class="col-md-12 tishi" style=" text-align: center;width: 90%;  color: #ff0220;display: none;" id="tishi">
    <img src="<?php echo base_url("resources/wm/images/jingao.png"); ?>" class="img-responsive tishi_img" />
    查询时间跨度不能超过3个月，重新选择起止日期!
</div>
    <div class="col-md-12 count_user">
        用户总数：<span id="renshu" class="renshu" >0</span>
    </div>
</div>
<!-- 数据表 -->
...
<script type="text/javascript">
    ...
    sFirst : "首页",
            ...
            ajax : {
    url : '<?php echo site_url("wm/wangmeng/yonghu/all"); ?>',
            dataSrc : "myData",
            type : "post",
            data : function (d) {
...
<?php endforeach; ?>
    ...
    $(".tishi").css("display", "block");
            ...
            search1();
            $.ajax({
    url: '<?php echo site_url("wm/wangmeng/yonghu/info"); ?>',
            type: 'POST',
            dataType: 'json',
