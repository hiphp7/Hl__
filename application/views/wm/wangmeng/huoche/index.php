...
<div class="col-md-12" style="font-size:1.8rem;">
    ...
    <img src="<?php echo base_url("resources/wm/images/leixing.png"); ?>" class="img-responsive leixing_img" />订单类型：
    <select name="zhuangtai" id="leixing" class="leixing" style="padding-right: 0px" >
        <option value="0" selected="selected">出票</option>
...
<div class="col-md-12 jipiao_count" style=" text-align: center; font-size: 25px; color: #333333; padding-right: 25%;">
    票数：<span id="piaoshuall">0</span>
...
<script type="text/javascript">
    ...
    sFirst : "首页",
            ...
            ajax : {
    url : '<?php echo site_url("wm/wangmeng/huoche/all"); ?>',
            dataSrc : "myData",
            type : "post",
            data : function (d) {
...
<?php endforeach; ?>
    /*, {
     ...
     // sData id 值
     $(nTd).html("<a style='display:none;' id='chakan_a_" + oData.id + "' href='<?php echo site_url("admin/huochepiao/chupiao/xiangqing/"); ?>/" + oData.id + "'>查看</a>&nbsp;&nbsp;");
     }
     }*/]
    ...
    $(".tishi").css("display", "block");
            ...
            search1();
            $.ajax({
    url: '<?php echo site_url("wm/wangmeng/huoche/info"); ?>',
            type: 'POST',
            dataType: 'json',
            data: {"datetimeStart": datetimeStart, "datetimeEnd":datetimeEnd, "leixing":leixing,'<?php echo $this->security->get_csrf_token_name(); ?>' : '<?php echo $this->security->get_csrf_hash(); ?>'},
    })
            .done(function(data) {
            $("#dingdanall").text(data.dingdanall);
            $("#piaoshuall").text(data.piaoshuall);
    })
