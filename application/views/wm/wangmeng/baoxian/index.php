...
<ol class="daohangtiao">
    ...
    <div class="col-md-12 jipiao_count" style=" text-align: center; font-size: 25px; color: #333333; padding-right: 25%;">
		...
		交易总数：<span id="dingdanzongjiaall">0</span>
    </div>
<!-- 数据表 -->
...
$('#dianpudiaoyan>tbody').css("display","none");
        $(function () {
            ...
            ajax : {
                url : '<?php echo site_url("wm/wangmeng/baoxian/all"); ?>',
                dataSrc : "myData",
                type : "post",
                data : function (d) {
    ...
    $('.chaxun').click(function () {
            ...
            $.ajax({
                url: '<?php echo site_url("wm/wangmeng/baoxian/info"); ?>',
                type: 'POST',
                dataType: 'json',
