...
<ol class="daohangtiao">
    <li><a href="">首页</a></li>
    <li><a href="">数据查询</a></li>
    <li class="active">查询国内机票订单</li>
</ol>
    <div class="col-md-12 jipiao_search">
...
$('#dianpudiaoyan>tbody').css("display","none");
        $(function () {
            ...
            ajax : {
                url : '<?php echo site_url("wm/wangmeng/feiji/all"); ?>',
                dataSrc : "myData",
                type : "post",
                data : function (d) {
    ...
    $('.chaxun').click(function () {
            ...
            $.ajax({
                url: '<?php echo site_url("wm/wangmeng/feiji/info"); ?>',
                type: 'POST',
                dataType: 'json',
