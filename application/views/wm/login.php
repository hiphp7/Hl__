...
<head>
	...
	<link href="<?php echo base_url("static/bootstrap/3.3.7/dist/css/bootstrap.min.css"); ?>" type="text/css" rel="stylesheet" />
	...
	<style type="text/css">
        ...
        .denglu{
             padding: 5px !important; font-size: 20px !important; color:white !important;
        }
		.denglu:active{
...
<div >
    ...
    <div  class="login_dingwei" >
        <div  style="width: 354px; padding: 20px 0;">
            <form class="form-horizontal" style="overflow:auto; box-shadow: 0px 0px 10px #666666; border: 0px none;"  autocomplete="on" id="loginform">
            <input type="hidden" name="<?php echo $this->security->get_csrf_token_name();?>"
                ...
                <div class="form_hang">
                    ...
                    <input type="text" class="form_h "autocomplete="off" name="name" id="name" placeholder="注册邮箱" onblur="show_Icon('user')"  value="<?php if(!empty($username)) echo $username ;?>">
                ...
                <div class="form_hang" style="margin: 20px">
                    ...
                    <button type="submit" id="login_btn" class="btn btn-default denglu" style="width: 100%; color:white !important;">登&nbsp;录</button>
                </div>
                <div class="form_hang" style="margin: 20px;float: right">
                 <a href="<?PHP echo site_url('wm/register/index')?>"> 个人用户注册</a>
                 </div>
            </form>
        </div>
    </div>
...
<script>
	function changeBtn(){
		if($('#name').val()==''){
			$('#login_btn').css('background','#8dd2d7');
			$('#name').mouseout(function(){
				if($('#name').val()==''){
					$('#login_btn').css('background','#8dd2d7');
				}
				else{
					$('#login_btn').css('background','#49d3dd');
				}
			})
		}
	}
...
<script>
    <?php if ($msg=='ok'):?> 
        alert("感谢您的注册，我们将在24小时内为您审核开通，账号在审核期间暂停登录，谢谢。");
     <?php endif?>
</script>
</body>
</html>