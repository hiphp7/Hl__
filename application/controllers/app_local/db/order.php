...
class order extends CI_Controller {
    ...
    public function tuigaiqian() {
        ...
        $get_data['agencyCode'] = $conf['Agency51Book'];
        $sign = md5($conf['Agency51Book'] . $airlineCode . $arrCode . $classCode . $depCode . $depDate . $conf['Security51Book']);
        $get_data['sign'] = $sign;
        $get_data['depDate'] = $depDate;
        $get_data['airlineCode'] = $airlineCode;
        $get_data['classCode'] = $classCode;
        $get_data['depCode'] = $depCode;
        $get_data['arrCode'] = $arrCode;
        $res = $this->mypost->request_get($url, $get_data);
    ...
    public function save() {
        ...
        // 发票
        $air_taitou = json_decode($this->input->get('air_taitou'));
