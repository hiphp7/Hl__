...
class Lunar {
    ...
    function getWeek($year, $month, $date) {
        $a = mktime(0, 0, 0, $year, $month, $date);

        $weekarray = array("日", "一", "二", "三", "四", "五", "六");

        return "星期" . $weekarray[date("w", $a)];
    }
    ...
    function getFestival($today, $nl_info = false, $config = 1) {
        if ($config == 1) {
            ...
            $arr_solar = array('01-01' => '元旦', '02-14' => '情人节', '03-08' => '妇女节', '03-12' => '植树节', '04-01' => '愚人节', '05-01' => '劳动节', '05-04' => '青年节', '06-01' => '儿童节', '10-01' => '国庆节', '10-31' => '万圣节', '12-24' => '平安夜', '12-25' => '圣诞节');
    ...
    function dateConversion($date) {
        ...
        $result = $this->convertSolarToLunar($Year, $Month, $Day);
    ...
    public function getDateList() {
        try {
            ...
            //return array('code' => 0, 'item' => $arrDate);
            //$data_ar = array('code' => 0, 'item' => $arrDate);
