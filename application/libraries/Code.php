...
class Code{
    ...
    private function createCode() {
        ...
        $CI->session->set_userdata('code', $this->code);
         */
    }
    ...
    public function create() {
        ...
        $bgColor1 = imagecolorallocate($img, hexdec(substr($bgColor, 1, 2)), hexdec(substr($bgColor, 3, 2)), hexdec(substr($bgColor, 5, 2)));
        imagefill($img, 0, 0, $bgColor1);
        $this->img = $img;
        $this->createLine();
        $this->createFont();
        $this->createPix();
